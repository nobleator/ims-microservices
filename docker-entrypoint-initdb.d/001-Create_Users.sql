...
CREATE TABLE IF NOT EXISTS ims_user (
    ims_user_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    name TEXT,
    description TEXT,
    password_salt TEXT,
    password_hash TEXT,
...
CREATE TABLE IF NOT EXISTS ims_role (
    ims_role_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    name TEXT,
    description TEXT
);

CREATE TABLE IF NOT EXISTS ims_user_role (
    ims_user_role_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
